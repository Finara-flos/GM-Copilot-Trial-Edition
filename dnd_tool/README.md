...
一个面向 DND 跑团主持人的本地桌面模组辅助工具。导入 PDF、TXT、Markdown 或 DOCX 模组后，可按段落阅读、维护关键词词库，并在配置自己的兼容 API 后使用 AI 精修、扩写、NPC 档案与翻译优化功能。
...
当前仓库尚未指定许可证。上传公开仓库前，请补充 `LICENSE` 文件以明确使用、修改和分发条件。
